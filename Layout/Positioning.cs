        ...
        static public void LineAlignCross (Box box)
        {
                ...
                box.LineAlignCross == UI.Structures.LineAlignCross.End)
            {
                ...
                if (box.LineAlignCross == UI.Structures.LineAlignCross.Start)
                    ...
                    crossPosition = Math.Max (0, box.ScrollAreaSize.Cross - usedCrossLength) / 2;
                else
                    crossPosition = Math.Max (0, box.ScrollAreaSize.Cross - usedCrossLength);
            ...
            {
                int usedCrossLength = box.Lines.Sum (i => i.FinalSize.Cross);
                Spacing spacing = Spacing.New (box.Lines.Count + 1, usedCrossLength, box.ScrollAreaSize.Cross);
            ...
            {
                int usedCrossLength = box.Lines.Sum (i => i.FinalSize.Cross);
                Spacing spacing = Spacing.New (box.Lines.Count, usedCrossLength, box.ScrollAreaSize.Cross);
                int space;
